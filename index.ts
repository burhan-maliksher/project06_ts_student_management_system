...
class _stdManagementSystem extends _Student {
  ...
  //operations
  private async MainOperations(): Promise<void> {
    //getting user choose from main menu and performing operations accordingly
    const operation_choosed: string = await this.MainMenu();
  ...
  private async MainMenu(): Promise<string> {
   ...
   //add student
   private async Addstd(): Promise<void> {
    let repeat: boolean;
    do {
  ...
  //enroll student
  private async Enrollstd(): Promise<void> {
   ...
   //pay fee
   private async PayFee(): Promise<void> {
  ...
  private async Exit(): Promise<void> {
    console.log(
      chalk.bgCyan("                    Thanks for Using M.B Student Management System                          "));
    return;
  }
